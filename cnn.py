#-------------------------------------------------------------------------
# AUTHOR: Luis Felix Reyes
# FILENAME: cnn.py
# SPECIFICATION: Program trains CNN to recognize digits by loading preprocessed images, create a model,train that model and ensure its accuracy.
...
print(f"The Test Accuracy: {acc*100:.2f}%")